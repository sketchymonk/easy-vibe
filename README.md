...
| 章节                                                                                                       | 关键内容                                                                     |
| :--------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------- |
| [快速上手利用大模型生成设计](https://datawhalechina.github.io/easy-vibe/zh-cn/stage-2/frontend/2.0-lovart-assets/)                             | 学习如何从零开始，利用大模型批量生成高质量的设计素材，并动手构建一个能理解长文本、自动生成配图的 AI 绘图助手。 |
