...
::: info نصيحة للمراجعة
إذا لم تكن معتاداً على ماهية IDE وما هي وظيفة كل عنصر في الواجهة، ننصحك بقراءة [مقدمة في IDE](/zh-cn/appendix/2-development-tools/ide-basics) أولاً، للتعرف على المفاهيم الأساسية والوظائف الشائعة لـ IDE.
:::
...
لمزيد من التفاصيل، يرجى مراجعة [قسم مبادئ IDE المرئي في الملحق](/zh-cn/appendix/2-development-tools/ide-basics).
...
للحصول على شرح أكثر تفصيلاً، يرجى الاطلاع على [قسم مبادئ IDE الافتراضي والمرئي في الملحق](/zh-cn/appendix/2-development-tools/ide-basics).
...
<el-card id="appendix-nav" shadow="hover" style="margin-top: 40px; margin-bottom: 24px; border-left: 5px solid #E6A23C;">
  ...
  <el-row :gutter="16">
    ...
    <el-col :span="12">
      <a href="/zh-cn/appendix/2-development-tools/ide-basics" style="text-decoration: none; color: inherit;"><b>الملحق الثاني: تحليل شريط القوائم في Visual Studio Code</b></a><br/>
