...
<NavGrid>
  <a href="/ja-jp/stage-2/backend/2.2-database-supabase/" class="card-link">
    <div class="content-card">
      <div class="card-header">
        <span class="card-icon">🗄️</span>
  ...
  <a href="/ja-jp/stage-2/backend/2.4-git-workflow/" class="card-link">
    <div class="content-card">
      <div class="card-header">
        <span class="card-icon">🌿</span>
  ...
  <a href="/ja-jp/stage-2/backend/2.5-zeabur-deployment/" class="card-link">
    <div class="content-card">
      <div class="card-header">
        <span class="card-icon">🚀</span>
  ...
  <a href="/ja-jp/stage-2/backend/2.6-modern-cli/" class="card-link">
    <div class="content-card">
      <div class="card-header">
        <span class="card-icon">💻</span>
...
<NavGrid>
  <a href="/ja-jp/stage-2/ai-capabilities/2.2-multimodal-api/" class="card-link">
    <div class="content-card">
      <div class="card-header">
        <span class="card-icon">🎭</span>
