...
1. 根据上述的所有作业，并 **重点参考章节一、二的内容，** 产出细化后的最终点子，使用 Trae 或结合 CLI IDE 制作第一款应用（不用强行加入 AI 功能，你可以制作一个非 AI 应用，一个 AI 应用）。
2. 为你的应用招募至少 20 个使用者，创建一个群聊维护用户社群。
